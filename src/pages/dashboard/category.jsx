...
import CreateModal from "@/components/dashboard/ModalCreateCategory";
import EditModal from "@/components/dashboard/ModalEditCategory";
import DeleteModal from "@/components/dashboard/ModalDeleteCategory";
...
const CategoryPage = () => {
	...
	useEffect(() => {
		getData("categories", (res) => {
			const dataFiltered = res?.data.data.filter((category) => category?.name.toLowerCase().includes(search.toLowerCase()));
				...
				<div className="w-full p-6 mx-auto">
					<div className="flex flex-wrap -mx-3">
						<div className="w-full max-w-full px-3 my-auto shrink-0 md:flex-0 md:w-2/4 lg:w-2/3">
							<h5 className="mb-0 text-2xl font-semibold dark:text-white">Category List</h5>
						</div>
					...
					<EditModal showEditModal={showEditModal} setShowEditModal={setShowEditModal} selectedCategory={selectedCategory} />
					<DeleteModal showDeleteModal={showDeleteModal} setShowDeleteModal={setShowDeleteModal} selectedCategory={selectedCategory} />
				</div>
			</main>
		</div>
	);
