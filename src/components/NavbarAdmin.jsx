...
const NavbarAdmin = () => {
	...
	return (
		<nav navbar-main="" className="flex flex-wrap items-center justify-between px-0 py-2 mx-6 mt-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start sticky top-[1%] backdrop-saturate-200 backdrop-blur-2xl bg-white/80 shadow-blur z-110 dark:bg-gray-950/80 dark:shadow-dark-blur z-50" navbar-scroll="false">
