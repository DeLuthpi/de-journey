							...
							<div className="relative flex flex-col min-w-0">
								<div className="items-center w-full">
									<div className="flex flex-row flex-wrap items-center justify-between w-full">
										...
										<p className={`inline text-sm md:text-base items-center ${selectedTransaction?.status === "success" ? "text-success" : selectedTransaction?.status === "cancelled" ? "text-danger" : "text-orangejuice"}`}>
											<span className="inline pr-1 md:text-lg">{selectedTransaction?.status === "success" ? <PiCheckCircle className="inline" /> : selectedTransaction?.status === "cancelled" ? <TbXboxX className="inline" /> : <PiClockCountdown className="inline" />}</span>
